...
- [ ] **C33 / P3:** Move accidental/generated root files (`$null`, `a.out`, pin dumps) to ignored build/log locations after review; keep checked-in audit evidence separate from executables. Acceptance: intended-source status is readable and reproducible. Candidate49 root-cleanliness receipt: `.mister/evidence/receipts/20260908T-candidate49-root-cleanliness.json`.
