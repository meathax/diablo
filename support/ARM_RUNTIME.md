...
not the launcher, owns the `flock` lease for its mapped lifetime. The final MiSTer
menu/profile binding remains C16 target work; do not hand-create an admission record
